...
=head1 Test suite 2: Formula object tests 
    (7) Constructor test
    (8)-(12). Getter method tests 
    (13) Invalid constructor
=cut

=head1 Test suite 3: Symbolic elementary functions

    (14)-(15). getStandardFuncsRegex test
...
my$f1 = Formula::new Formula("ab", "c", "a*b+c", 3); #(12)
ok($f1->getNesting, 3); #(13)
...
ok(Formula::getStandardFuncs(14)); #TODO: make non lazy test for this
